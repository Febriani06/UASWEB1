...
<div class="container mt-5 text-center"> <!-- Menambahkan class "text-center" -->
        <div class="row">
            <div class="col-md-12">
...
function fetchData(tahun) { 
    ...
    return axios({
    method: 'post',
    url: 'https://tubesgroup4.000webhostapp.com/dashboard/sum_beritatahun.php',
    data: formData,
...
axios.get('https://tubesgroup4.000webhostapp.com/dashboard/select_tahun.php')
    .then(response => {
...
axios.get('https://tubesgroup4.000webhostapp.com/dashboard/sum_berita.php')
